...
const MobileSlider = () => {
  const data = [
    ...
    {
      title: "[2000-2010]",
      desc: ['Покупка квартиры под офис.', 'Строительство 2-х собственных офисов через реконструкцию', 'Открыла отдел через расселение коммунальных квартир', 'Создала пассивный доход из коммерческих помещений', 'Появилась мечта работать в Москве']
    },
    {
      title: "[2010-2020]",
