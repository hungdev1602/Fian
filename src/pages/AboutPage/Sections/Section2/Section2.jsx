...
const Section2 = () => {
  ...
  const experienceData = [
    ...
    {
      title: "[2000-2010]",
      desc: ['Покупка квартиры под офис с последующем выводим из ЖФ.', 'Строительство 2-х собственных офисов через реконструкцию', 'Открыла отдел ПО расселению коммунальных квартир', 'Создала пассивный доход из коммерческих помещений', 'Появилась мечта работать в Москве']
    },
    {
      title: "[2010-2020]",
