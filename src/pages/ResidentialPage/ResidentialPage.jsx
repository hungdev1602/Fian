...
const ResidentialPage = () => {
  ...
  const dataServiceRight = {
      ...
      buttonText: "Продать",
      heightImg: "h-[339px] md:h-[667px] lg:h-[906px] 2xl:h-[1113px]"
  }
  const dataServiceLeft = {
      ...
      buttonText: "Купить",
      heightImg: "h-[339px] md:h-[667px] lg:h-[883px] 2xl:h-[1023px]"
  }
  const dataServiceRight1 = {
    ...
    максимально выгодных условиях.`,
    buttonText: "Купить",
    heightImg: "h-[339px] md:h-[592px] lg:h-[870px] 2xl:h-[1023px]"
  }
  return (
    <>
