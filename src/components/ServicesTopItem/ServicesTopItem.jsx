  ...
  return (
    <>
      <div className="flex justify-between items-start mb-[120px]">
        <Header1 />
        <div className={`w-[870px] h-[640px] ${dataServiceItemTop.backgroundImg} bg-cover rounded-[20px] relative truncate`}>
          {/* contact */}
      ...
      <div className="w-[600px] mt-[-685px]">
        ...
        <div className="mt-[90px]">
          <div className="text-[24px] font-[500] text-[#494949] leading-[29px]">{dataServiceItemTop.formTitle}</div>
