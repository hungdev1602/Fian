        ...
        <div className="w-full lg:w-[500px] 2xl:w-[630px] mt-[30px] sm:mt-0 lg:mt-[-456px] xl:mt-[-557px] 2xl:mt-[-685px]">
          ...
          <div className="mt-[30px] lg:mt-[60px] 2xl:mt-[90px] flex items-center justify-center sm:justify-normal gap-[20px] 2xl:gap-[25px]">
            <div className="text-center sm:text-left 2xl:text-center">
              <div className="text-[16px] sm:text-[20px] 2xl:text-[24px] font-[700] text-[#484848] leading-[19.36px] sm:leading-[24.2px] 2xl:leading-[29px] tracking-tighter sm:tracking-normal">{dataServiceItemTop.desc[0].title}</div>
              <div className="text-[11px] sm:text-[16px] 2xl:text-[18px] font-[400] text-[#000000CC] leading-[14.7px] sm:leading-[19.6px] 2xl:leading-[21.78px] mt-[5px] 2xl:mt-[10px]">{dataServiceItemTop.desc[0].subtitle}</div>
            </div>
            ...
            <div className="text-center sm:text-left 2xl:text-center">
              ...
              <div className="text-[11px] sm:text-[16px] 2xl:text-[18px] font-[400] text-[#000000CC] leading-[14.7px] sm:leading-[19.6px] 2xl:leading-[21.78px] mt-[5px] 2xl:mt-[10px]">{dataServiceItemTop.desc[1].subtitle}</div>
            </div>
          </div>
