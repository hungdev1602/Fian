  ...
  return (
    <>
      <div className={`w-auto lg:w-[260px] 2xl:w-[390px] h-[164px] sm:h-[240px] 2xl:h-[268px] rounded-[20px] pt-[20px] px-[10px] 2xl:px-[23px] text-center relative ${check ? "bg-[#F3F3F3]" : "bg-white"}`}>
        <div className="text-base sm:text-[21px] 2xl:text-[28px] font-[400] font-avenirLight leading-[19px] sm:leading-[29.4px] 2xl:leading-[34.3px] uppercase whitespace-pre-line sm:whitespace-normal 2xl:whitespace-pre-line">
          {title}
        </div>
        <div className="text-[11px] sm:text-[13px] 2xl:text-[19px] font-[300] leading-[12px] sm:leading-[20px] mt-[10px] sm:mt-[20px] whitespace-pre-line sm:whitespace-normal 2xl:whitespace-pre-line">
