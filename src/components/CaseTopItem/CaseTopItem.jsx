        ...
        <div className="flex gap-[10px] sm:hidden bg-[#797979] py-[10px] pl-[10px] pr-[10px] h-[50px] text-white">
          {
            dataServiceItemTop.cards.map((item, index) => (
              <div 
                key={index}
                className="w-[120px] h-[30px] flex items-center justify-center text-[13px] font-avenirThin rounded-[60px] bg-transparent border border-white"
              >
                {item}
              </div>
            ))
      ...
      <div className="container mx-auto">
        <div className="w-full md:w-[630px] mt-[30px] sm:mt-0 md:mt-[-550px] lg:mt-[-555px] 2xl:mt-[-685px]">
          ...
          <div className="mt-[30px] 2xl:mt-[40px]">
            <div className="text-[18px] sm:text-[20px] 2xl:text-[24px] font-[400] text-[#313131] font-avenir leading-[22px] sm:leading-[24.5px] 2xl:leading-[29.4px]">[Запрос]</div>
          ...
          <div className="mt-[20px] sm:mt-[30px] 2xl:mt-[40px] mb-[20px] sm:mb-[30px] 2xl:mb-[40px]">
            <div className="text-[18px] sm:text-[20px] 2xl:text-[24px] font-[400] text-[#313131] font-avenir leading-[22px] sm:leading-[24.5px] 2xl:leading-[29.4px]">[Решение]</div>
